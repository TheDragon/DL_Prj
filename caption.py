...
import models  # for safe unpickling allowlist
...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=3):
    ...
    # skimage.resize returns float images in [0, 1] by default.
    # Do NOT divide by 255 here, or the image becomes ~0 and captions collapse.
...
if __name__ == '__main__':
    ...
    # Load model, avoiding legacy optimizer unpickling crashes.
    # Monkey-patch Adam.__setstate__ to tolerate legacy state dicts without 'defaults'.
